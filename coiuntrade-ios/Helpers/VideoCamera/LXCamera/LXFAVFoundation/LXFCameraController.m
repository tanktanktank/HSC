...
- (void)viewDidLoad
{
    ...
    self.tipLabel.text = @"长按录像";
    self.codeLabel.text = [NSString stringWithFormat:@"[我的验证码是%@]",self.readCode];
}
...
//        _readLabel.text = @"[我的验证码是892739]";
//        _readLabel.textColor = [[UIColor redColor] colorWithAlphaComponent:0.382];
//        _readLabel.font = [UIFont systemFontOfSize:16];
