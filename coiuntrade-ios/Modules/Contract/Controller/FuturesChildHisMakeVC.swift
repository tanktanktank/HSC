...
class FuturesChildHisMakeVC: BaseViewController {
    ...
    lazy var tableView : BaseTableView = {
        ...
        table.register(FuturesHisMakeCell.self, forCellReuseIdentifier:  FuturesHisMakeCell.CELLID)
        return table
    }()
...
// MARK: - UI
extension FuturesChildHisMakeVC {
    func setUI() {
...
extension FuturesChildHisMakeVC : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: FuturesHisMakeCell.CELLID, for: indexPath) as! FuturesHisMakeCell
...
extension FuturesChildHisMakeVC : JXPagingViewListViewDelegate{
