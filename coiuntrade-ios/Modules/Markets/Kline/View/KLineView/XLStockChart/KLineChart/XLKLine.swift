...
//            return Int((renderWidth - theme.candleWidth) / ( theme.candleWidth + theme.candleGap))
    ...
    func drawMainMALayer(array: [XLKLineCoordModel]) {
        ...
        ma5LineLayer.lineWidth = theme.topLineOneWidth
        ...
        ma10LineLayer.lineWidth = theme.topLineTwoWidth
        ...
        ma30LineLayer.lineWidth = theme.topLineThreeWidth
    ...
    func drawBOLLLayer(array: [XLKLineCoordModel]) {
        ...
        upBollLineLayer.strokeColor = theme.topBollUpColor.cgColor
        upBollLineLayer.fillColor = UIColor.clear.cgColor
        upBollLineLayer.lineWidth = theme.topBollUpWidth
        
        midBollLineLayer.frame = bounds
        midBollLineLayer.path = midBollLinePath.cgPath
        midBollLineLayer.strokeColor = theme.topBollMidColor.cgColor
        midBollLineLayer.fillColor = UIColor.clear.cgColor
        midBollLineLayer.lineWidth = theme.topBollMidWidth
        
        lowBollLineLayer.frame = bounds
        lowBollLineLayer.path = lowBollLinePath.cgPath
        lowBollLineLayer.strokeColor = theme.topBollBottomColor.cgColor
        lowBollLineLayer.fillColor = UIColor.clear.cgColor
        lowBollLineLayer.lineWidth = theme.topBollBottomWidth
    ...
    func drawKDJLayer(array: [XLKLineCoordModel]) {
        ...
        kdj_K_LineLayer.strokeColor = theme.bottomKDJKColor.cgColor
        kdj_K_LineLayer.fillColor = UIColor.clear.cgColor
        kdj_K_LineLayer.lineWidth = theme.bottomKDJKLineW
        
        kdj_D_LineLayer.frame = bounds
        kdj_D_LineLayer.path = KDJ_D_LinePath.cgPath
        kdj_D_LineLayer.strokeColor = theme.bottomKDJDColor.cgColor
        kdj_D_LineLayer.fillColor = UIColor.clear.cgColor
        kdj_D_LineLayer.lineWidth = theme.bottomKDJDLineW

        kdj_J_LineLayer.frame = bounds
        kdj_J_LineLayer.path = KDJ_J_LinePath.cgPath
        kdj_J_LineLayer.strokeColor = theme.bottomKDJDColor.cgColor
        kdj_J_LineLayer.fillColor = UIColor.clear.cgColor
        kdj_J_LineLayer.lineWidth = theme.bottomKDJJLineW
    ...
    func drawMACD_DIF_DEA_Layer(array: [XLKLineCoordModel]) {
        ...
        macd_diffLayer.strokeColor = theme.bottomMACDDifColor.cgColor //theme.bottomTextThreeColor.cgColor
        macd_diffLayer.fillColor = UIColor.clear.cgColor
        macd_diffLayer.lineWidth = theme.bottomMACDDifLW
        
        macd_deaLayer.frame = bounds
        macd_deaLayer.path = deaLinePath.cgPath
        macd_deaLayer.strokeColor = theme.bottomMACDDeaColor.cgColor //theme.bottomTextFourColor.cgColor
        macd_deaLayer.fillColor = UIColor.clear.cgColor
        macd_deaLayer.lineWidth = theme.bottomMACDDeaLW
    ...
    func drawRsiLayer(array: [XLKLineCoordModel]) {
        ...
        rsiLineLayer.strokeColor = theme.bottomRSIRColor.cgColor //theme.bottomTextTwoColor.cgColor
        rsiLineLayer.fillColor = UIColor.clear.cgColor
        rsiLineLayer.lineWidth = theme.bottomRSIRLineW
