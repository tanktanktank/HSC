...
class XLBottomChartTextLayer: XLCAShapeLayer, XLDrawLayerProtocol {
    ...
    func configureBottomValue(secondDrawString: String, one: CGFloat, two: CGFloat, three: CGFloat) {
        ...
        if secondDrawString == KLINEVOL {
            ...
            // MACD
            let oneString = "MACD(" + theme.bottomMACDDif + "," + theme.bottomMACDDea + "," + theme.bottomMACDAvg + ") "//"MACD(12,26,9) "
            ...
            // KDJ
            let oneString = "KDJ(" + theme.bottomKDJk + "," + theme.bottomKDJd + "," + theme.bottomKDJj + ") "//"KDJ(9,3,3) "
            ...
            // RSI
//            let twoString = "RSI(6): " + one.xlChart.kLineVolNumber()
            let twoString = "RSI(" + theme.bottomRSIR + "): " + one.xlChart.kLineVolNumber()
