...
class XLHighLowTextLayer: CAShapeLayer {
    ...
    public func moveHighLowLayer(highPoint: CGPoint, highPrice: CGFloat, lowPoint: CGPoint, lowPrice: CGFloat, startX: CGFloat) {
        ...
        if highPoint == CGPoint.zero {
            ...
            var highMarkString = highPrice.xlChart.kLinePriceNumber()
            highMarkString = self.addMicrometerLevel(valueSwift: highMarkString)
        ...
        if lowPoint == CGPoint.zero {
            ...
            var lowMarkString = lowPrice.xlChart.kLinePriceNumber()
            lowMarkString = self.addMicrometerLevel(valueSwift: lowMarkString)
