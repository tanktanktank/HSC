...
class WithDrawDetailVC: BaseViewController {
    ...
    lazy var detailLab : UILabel = {
        ...
        v.text = "从平台转出的加密货币。请联系收款平台索取您的交易收据。".localized()
        return v
    }()
    ...
    lazy var accountV : RechageDetailCellView = {
        let v = RechageDetailCellView()
        v.titleV.text = "充值账户".localized()
        v.contentV.text = "现货账户"
        v.type = .normal
        return v
    }()
    lazy var addressV : RechageDetailCellView = {
        let v = RechageDetailCellView()
        v.titleV.text = "地址".localized()
    ...
    override func viewDidLoad() {
        ...
        self.titleLab.text = "提现详情".localized()
...
extension WithDrawDetailVC{
    ...
    func initSubViewsConstraints(){
        ...
        addressV.snp.makeConstraints { make in
            make.left.right.equalToSuperview()
            make.top.equalTo(accountV.snp.bottom).offset(5)
        }
