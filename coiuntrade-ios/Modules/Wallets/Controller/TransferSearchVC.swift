...
//  coiuntrade-ios
//
//  Created by tfr on 2022/6/27.
//

import UIKit

class TransferSearchVC: BaseViewController {
    ...
    lazy var cancelBtn : ZQButton = {
        let btn = ZQButton()
        btn.setTitle("common_cancel".localized().localized(), for: .normal)
...
//    var titles :[String] = ["现货".localized(),"合约".localized()]
    var titles :[String] = ["数字货币".localized()]
...
extension TransferSearchVC : JXPagingViewDelegate {
...
extension TransferSearchVC : JXPagingMainTableViewGestureDelegate{
...
extension TransferSearchVC : JXSegmentedViewDelegate{
