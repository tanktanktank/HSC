...
import UIKit
import MZCircleProgress

class EntrustShowCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        let circleProgress = MZCircleProgress(frame: CGRect(x: 0, y: 0, width: 30, height: 30))
        circleProgress.backLineColor = .red
        circleProgress.backLineWidth = 2
        circleProgress.progressColor = .orange
        circleProgress.progressWidth = 2
        ...
        self.vProgress.addSubview(circleProgress)
    }
